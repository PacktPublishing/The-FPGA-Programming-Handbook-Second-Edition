...
#
# Generated by Vivado on Sun Mar 12 19:58:53 CDT 2023
...
#
#    "/home/fbruno/git/books/The-FPGA-Programming-Handbook-Second-Edition/CH8/VHDL/build/i2c_temp_flt_bd.srcs/utils_1/imports/synth_1/flt_temp.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/fbruno/git/books/The-FPGA-Programming-Handbook-Second-Edition/CH8/VHDL/ip_source/flt_temp/hdl/flt_temp.vhd"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../VHDL/build/i2c_temp_flt_bd.srcs/utils_1/imports/synth_1/flt_temp.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../VHDL/ip_source/flt_temp/hdl/flt_temp.vhd"]"\
 "[file normalize "$origin_dir/i2c_temp.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../VHDL/VHDL/ip_source/adt7420_i2c"]"]"\
 "[file normalize "$origin_dir/../VHDL/VHDL/ip_source/seven_segment"]"]"\
 "[file normalize "$origin_dir/../VHDL/VHDL/IP"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../VHDL/build"]"
...
set_property -name "xpm_libraries" -value "XPM_CDC XPM_COMP_DECL XPM_FIFO" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../VHDL/ip_source/adt7420_i2c"] [file normalize "$origin_dir/../VHDL/ip_source/seven_segment"] [file normalize "$origin_dir/../VHDL/IP"]" $obj
...
set file "$origin_dir/../VHDL/ip_source/flt_temp/hdl/flt_temp.vhd"
...
set file "[file normalize "$origin_dir/i2c_temp.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/i2c_temp.xdc"
set file [file normalize $file]
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  packtpub.com:user:adt7420_i2c:1.0\
  xilinx.com:ip:clk_wiz:6.0\
  xilinx.com:ip:floating_point:7.1\
  pktpub.com:user:flt_temp:1.0\
  xilinx.com:ip:util_vector_logic:2.0\
  packtpub.com:user:seven_segment:1.0\
  "
  ...
  set flt_temp_0 [ create_bd_cell -type ip -vlnv pktpub.com:user:flt_temp:1.0 flt_temp_0 ]
  ...
  set seven_segment_0 [ create_bd_cell -type ip -vlnv packtpub.com:user:seven_segment:1.0 seven_segment_0 ]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../VHDL/build/i2c_temp_flt_bd.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/i2c_temp_flt_bd.srcs/utils_1/imports/synth_1/flt_temp.dcp" -objects $obj
